    ...
    def find_best_key(self, keys, pos):
        ...
        for letter in keys:
            ...
            for crypt in self.cryptograms:
                ...
                # check if XOR gets char from alphabet
